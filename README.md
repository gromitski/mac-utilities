...
| :--- | :--- | :--- |
| **`clean`** | Master on-demand CLI & Alfred trigger (`clean`, `clean screenshots`, `clean downloads`, `clean desktop`, `clean app-leftovers`, `clean clipboard`, `clean url`, `clean deep`, `clean -n`). | [Instructions & Details](docs/clean.md) |
