...
| :--- | :--- | :--- |
| **`clean`** | Master on-demand CLI & Alfred trigger (`clean`, `clean screenshots`, `clean downloads`, `clean desktop`, `clean app-leftovers`, `clean branches`, `clean clipboard`, `clean url`, `clean deep`, `clean -n`). | [Instructions & Details](docs/clean.md) |
...
| **App Leftovers Cleaner** | Ultra-safe scanner for orphaned data left by uninstalled apps with whitelist & 60-day recency protection. | [Instructions & Details](docs/app_leftovers.md) |
| **Git Branch Cleaner** | Prunes merged and dead remote-tracking branches with protected branch and active branch safeguards. | [Instructions & Details](docs/git_branches.md) |
| **Clipboard Cleaner** | Instant privacy memory flushing, plain-text styling stripper, and zero-width space remover. | [Instructions & Details](docs/clipboard_cleaner.md) |
...
tccutil reset SystemPolicyDesktopFolder com.runningwithcrayons.Alfred
```
